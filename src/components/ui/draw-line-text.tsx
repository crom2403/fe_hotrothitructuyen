...
export const DrawLineText = ({ text, oneByOne = true, afterFill = true, color = '#101827', fontSize = 40, wordSpacing = 10, strokeWidth = 1, letterSpacing = 0, ...props }: DrawTextProps) => {
  ...
  useGSAP(
    () => {
      ...
      children.forEach((el, index) => {
        ...
        totalWidth += +(elementWidth == 0 ? wordSpacing : elementWidth) + (children.length - 1 != index ? letterSpacing : 0);
