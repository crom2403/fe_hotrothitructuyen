      ...
      <Card className="border-0 shadow-lg max-w-3xl mx-auto mt-10">
        <CardHeader className="text-center pb-4">
          ...
          <CardTitle className="text-xl">
            {resultStatus === "passed" ? (
              <span className="text-green-600">Chúc mừng! Bạn đã đậu</span>
            ) : (
              <span className="text-red-600">Rất tiếc! Bạn chưa đậu</span>
            )}
          </CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center space-y-4">
            <div className="space-y-2">
              ...
              <Badge
                variant="outline"
                className={`text-lg px-4 py-1 ${resultStatus === "passed"
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                  ...
                  <span className="font-semibold text-blue-600">
                    {examResult?.duration_seconds} phút
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  ...
                  <span className="font-semibold text-green-600">
                    {examResult?.total_questions} câu
                  </span>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-sm space-y-1">
                    ...
                    <p>
                      <span className="font-medium">Nộp bài lúc:</span>{" "}
                      {new Date(examResult?.submitted_at || '').toLocaleString("vi-VN")}
                    </p>
                  </div>
                </div>
              </div>
