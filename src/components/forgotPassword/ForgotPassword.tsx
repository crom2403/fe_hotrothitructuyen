        ...
        <div>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-5' action='POST'>
                    ...
                    <FormControl>
                      <div>
                        <Input type='email' placeholder='Nhập email' {...field}
                          className='w-[320px] h-[40px] border-2 border-gray-300 rounded-md'
                        />
                      </div>
                    </FormControl>
                    <FormMessage />
              ...
              />
              <Button type='submit' className='w-[320px] h-[40px] bg-blue-800 hover:bg-blue-700 text-white rounded-md hover:opacity-90'
                disabled={isLoading}
              >
